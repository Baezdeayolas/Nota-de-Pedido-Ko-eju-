...
function generatePdfBytes(orderState) {
  ...
  y -= 17;
  currentLines.push({ x: marginLeft, y, size: 12, bold: false, font: 'sans', text: `Condición de venta: ${orderState.condicion || '-'}` });
  y -= 17;
  currentLines.push({ x: marginLeft, y, size: 12, bold: false, font: 'sans', text: `Lista de precio: M${orderState.tier}` });
  y -= 17;
